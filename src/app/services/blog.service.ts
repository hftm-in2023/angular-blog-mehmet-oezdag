  ...
  private mockPosts: BlogPost[] = [
    {
      ...
      content: 'Angular 19 bringt viele spannende neue Features mit sich, einschließlich der neuen Control Flow Syntax (@if, @for, @switch) und verbesserter Performance. In diesem Artikel erkunden wir die wichtigsten Neuerungen und wie sie die Entwicklung moderner Web-Anwendungen revolutionieren.',
    ...
    },
    {
      ...
      content: 'CSS Grid und Flexbox sind die modernen Layouttechniken für responsive Webdesign. Dieser Artikel zeigt praktische Beispiele und Best Practices für den Einsatz in realen Projekten.',
      author: 'Mehmet Oezdag',
    ...
    },
    {
      ...
      content: 'TypeScript hat sich als Standard für JavaScript-Entwicklung etabliert. Hier sind die wichtigsten Best Practices und Patterns für sauberen, typsicheren Code.',
      author: 'Mehmet Oezdag',
    ...
    },
    {
      ...
      content: 'Azure Static Web Apps bietet eine einfache und kostengünstige Möglichkeit, moderne Web-Anwendungen zu deployen. Dieser Guide zeigt den kompletten Deployment-Prozess.',
      author: 'Mehmet Oezdag',
    ...
    },
    {
      ...
      content: 'Angular Material bietet eine umfassende Sammlung von UI-Komponenten. Lernen Sie, wie Sie responsive und benutzerfreundliche Interfaces erstellen.',
      author: 'Mehmet Oezdag',
